...
def CreateSplits(positive_class, positive_subjects, negative_subjects,validation=False, return_list = True):
    train = []
    val = []
    test = [] 
...
def CreateRandomSplits(positive_subjects, negative_subjects, percent_val = None, percent_test = 0.3,return_list = True):
